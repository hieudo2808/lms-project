...
export const QuestionEditor = ({ initialData, onSubmit, onCancel }: QuestionEditorProps) => {
                ...
                {questionType !== 'SHORT_ANSWER' && (
                    <div className="space-y-3 mt-4">
                        ...
                        {answers.map((a, idx) => (
                                  ...
                                  : 'border-gray-300 text-transparent hover:border-green-400'
                                    ...
                                    >
                                        <CheckCircle
                                            size={16}
                                            fill="currentColor"
                                            className={a.isCorrect ? 'text-white' : 'text-transparent'}
                                        />
                                    </div>
                                </div>
                          ...
                          ${
                              a.isCorrect
                                  ? 'border-green-300 bg-green-50 ring-green-200'
