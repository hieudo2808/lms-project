...
interface QuizInfoFormProps {
  ...
  submitLabel?: string;
  submitButtonId?: string; // ID để kích hoạt submit từ bên ngoài
}
...
export const QuizInfoForm = ({
  ...
  // Khởi tạo state với tên trường khớp Backend
  ...
  // Hàm xử lý submit có validate cơ bản
  const handleSubmit = () => {
    if (!form.title.trim()) {
