...
export const AdminSidebar = ({ isOpen, onClose }: AdminSidebarProps) => {
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`w-64 bg-slate-900 border-r border-slate-700 h-screen fixed left-0 top-0 flex flex-col z-50 transition-transform duration-300 lg:translate-x-0 ${
