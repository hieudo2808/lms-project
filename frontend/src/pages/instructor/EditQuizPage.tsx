...
export const EditQuizPage = () => {
    ...
    const handleCreateQuestion = async (questionData: any) => {
        try {
            ...
            console.error(err);
            toast.error(
                isEditingQuestion ? 'Lỗi cập nhật câu hỏi: ' + err.message : 'Lỗi thêm câu hỏi: ' + err.message,
            );
        }
    };
        ...
        <div className="max-w-6xl mx-auto py-8 px-4 pb-20">
            <div className="flex items-center justify-between mb-6 sticky top-0 bg-gray-50 py-4 z-10">
                ...
                <div className="flex gap-3">
                    <button onClick={handleDeleteQuiz} className="btn-danger flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-8">
                    ...
                    <div className="bg-white p-6 rounded-xl border shadow-sm min-h-[500px]">
                        {isAddingQuestion ? (
                            <QuestionEditor onCancel={handleCancelQuestion} onSubmit={handleCreateQuestion} />
                        ) : isEditingQuestion ? (
                            <QuestionEditor
