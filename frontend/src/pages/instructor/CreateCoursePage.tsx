...
import { BookPlus, Type, ArrowRight, Loader2, DollarSign, BarChart, Tag, AlertCircle } from 'lucide-react';
                ...
                <form onSubmit={handleCreate} className="space-y-8">
                    <div>
                        <label className="block text-sm font-bold text-gray-700 mb-2 flex items-center gap-2">
                            <Type size={18} className="text-blue-500" /> Tên khóa học{' '}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            ...
                            <p className="mt-2 text-xs text-gray-500 italic">* Để 0 nếu là khóa học miễn phí.</p>
                        </div>
                    ...
                    <div>
                        <label className="block text-sm font-bold text-gray-700 mb-2 flex items-center gap-2">
                            <Tag size={18} className="text-orange-500" /> Danh mục{' '}
                            <span className="text-red-500">*</span>
                        </label>
                        <div className="relative">
                            <select
