        ...
        return (
            <Layout>
                <div className="max-w-6xl mx-auto px-4 py-12 text-center">
                    ...
                    <h2 className="text-2xl font-bold text-gray-800 mb-2">Không thể tải chứng chỉ</h2>
        ...
        <Layout>
            <div className="max-w-6xl mx-auto px-4 py-12">
                <div className="mb-8">
                    ...
                    <p className="text-gray-600">Danh sách các chứng chỉ bạn đã đạt được sau khi hoàn thành khóa học</p>
                </div>
                ...
                {certificates.length === 0 ? (
                    <div className="text-center py-20 bg-gray-50 rounded-xl">
                        ...
                        <h2 className="text-2xl font-bold text-gray-800 mb-2">Chưa có chứng chỉ nào</h2>
                        <p className="text-gray-600">Hoàn thành khóa học để nhận chứng chỉ của bạn!</p>
                    </div>
                ) : (
                                    ...
                                    <div className="flex items-start justify-between">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-amber-100 text-sm">Mã: {cert.certificateCode}</p>
                                            </div>
                                        </div>
                                        {cert.isValid && <CheckCircle className="text-green-300" size={24} />}
                                    </div>
                                </div>
