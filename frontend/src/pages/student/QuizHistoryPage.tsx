...
import { Trophy, Clock, CheckCircle, XCircle, Calendar, ArrowLeft, Eye, TrendingUp, Award, Target } from 'lucide-react';
...
export const QuizHistoryPage = () => {
    ...
    const avgScore = totalAttempts > 0 ? attempts.reduce((sum, a) => sum + (a.percentage || 0), 0) / totalAttempts : 0;
        ...
        <Layout>
            <div className="max-w-6xl mx-auto px-4 py-8">
                ...
                <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-2xl p-8 mb-8 shadow-lg">
                    ...
                    {quiz.description && <p className="text-blue-100 mb-4">{quiz.description}</p>}
                                ...
                                <div key={attempt.attemptId} className="p-6 hover:bg-gray-50 transition-colors">
                                    ...
                                    {selectedAttempt === attempt.attemptId && (
                                        <div className="mt-4 pt-4 border-t border-gray-200">
                                            <h4 className="font-semibold text-gray-900 mb-3">Chi tiết từng câu hỏi:</h4>

                                            {!attempt.endTime || attempt.status === 'IN_PROGRESS' ? (
                                                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 text-center">
                                                    <p className="text-yellow-800">
                                                        Bài quiz này chưa được hoàn thành hoặc đang trong quá trình làm
                                                        bài.
                                                    </p>
                                                </div>
                                            ) : (
