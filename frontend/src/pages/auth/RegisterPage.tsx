...
export const RegisterPage = () => {
    ...
    const [registerMutation] = useMutation<RegisterMutationData, RegisterMutationVariables>(REGISTER_MUTATION);
                ...
                <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
                    <div className="bg-white rounded-xl shadow-xl max-w-xl w-full mx-4 max-h-[80vh] overflow-y-auto p-6">
                        <div className="flex items-center justify-between mb-4">
                            <h2 className="text-xl font-bold text-gray-800">Điều khoản dịch vụ</h2>
                            <button
                        ...
                        <div className="text-sm text-gray-700 space-y-3">
                            <p>
                                Bằng việc sử dụng nền tảng LMS, bạn đồng ý không chia sẻ tài khoản, không phát tán nội
                                dung khóa học khi chưa được phép, và tuân thủ đầy đủ quy định của chúng tôi.
                            </p>
                            <p>
                                Mọi nội dung trong khóa học thuộc bản quyền của giảng viên và nền tảng. Bạn chỉ được
                                phép sử dụng cho mục đích học tập cá nhân.
                            </p>
                            <p>
                                Chúng tôi có thể cập nhật điều khoản mà không cần thông báo trước. Việc bạn tiếp tục sử
                                dụng nền tảng đồng nghĩa với việc chấp nhận các thay đổi này.
                            </p>
                        </div>

                        <div className="mt-6 flex justify-end gap-3">
                            <Button variant="secondary" type="button" onClick={() => setShowTerms(false)}>
                                Đóng
                            </Button>
                            <Button
                                variant="primary"
