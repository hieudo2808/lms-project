...
public interface EnrollmentRepository extends JpaRepository<Enrollment, UUID> {
    ...
    default boolean existsByUserAndCourse(com.seikyuuressha.lms.entity.Users user, com.seikyuuressha.lms.entity.Course course) {
        return existsByUser_UserIdAndCourse_CourseId(user.getUserId(), course.getCourseId());
    }
    
    default Optional<Enrollment> findByUserAndCourse(com.seikyuuressha.lms.entity.Users user, com.seikyuuressha.lms.entity.Course course) {
